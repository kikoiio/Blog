...
> [!note] 学习路径
> 以下20种技术按照"分块优化 → 检索增强 → 生成优化 → 系统级策略"的逻辑组织，建议按顺序学习。
...
## 4. 上下文片段标题（Contextual Chunk Headers）
...
## 17. 分层检索RAG（Hierarchical Retrieval）
